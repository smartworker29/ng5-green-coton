...
export class TopSlope extends TextShapeType {
  public name = 'topslope';
    ...
    return Observable.create((observer) => {
      this.getPlainTextCanvas().subscribe(textCanvas => {
        ...
        while (drawLocX <= bitmapWidth) {
          ...
          // Position the y so that the slope is at the top
          translateMatrix.ty = bitmapHeightAdjusted - (bitmapHeight * translateMatrix.d);
